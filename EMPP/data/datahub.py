...
from .conformer import UniMolV2Feature
from .multi_conformer import MultiConformerGen as ConformerGen  # 直接替换为多构象生成器
...
class DataHub(object):
    ...
    def _init_data(self, **params):
        ...
        if mols is not None:
            logger.info("Start saving conformers to SDF file...")
            self.save_mol2sdf(self.data['raw_data'], mols, params)
            logger.info("Finished saving conformers to SDF file.")
